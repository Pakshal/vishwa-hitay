...
export default function PageHeader({ eyebrow, title, children }) {
  return (
    <Box bgGradient="linear(to-b, brand.parchment, brand.white)" color="brand.navy" position="relative" overflow="hidden">
      <Box position="absolute" inset="0" color="brand.navy" opacity=".045" fontFamily="heading" fontSize={{ base: '68px', md: '150px' }} whiteSpace="nowrap" display="flex" alignItems="center" justifyContent="center">वसुधैव कुटुम्बकम्</Box>
      <Container maxW="1180px" py={{ base: 16, md: 24 }} position="relative">
        <Text color="brand.saffron" fontSize="11px" letterSpacing=".24em" textTransform="uppercase" mb={4}>{eyebrow}</Text>
